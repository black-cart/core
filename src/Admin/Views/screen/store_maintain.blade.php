        ...
        <div class="card">
            ...
            <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"
                ...
                <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header with-border">
                                <h3 class="card-title">{{ $language->name }} {!! bc_image_render($language->icon,'20px','20px', $language->name) !!}</h3>
...
<script type="text/javascript">
    ...
    {
        filebrowserImageBrowseUrl: '{{ bc_route_admin('admin.home').'/'.config('lfm.url_prefix') }}?type=content',
        filebrowserImageUploadUrl: '{{ bc_route_admin('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=content&_token={{csrf_token()}}',
