          ...
          <div class="card-body">
             <table class="table">
               <tbody>
                <tr>
                  <td>
                    {!! bc_language_render('env.ADMIN_FOOTER_OFF') !!}
                  </td>
                  <td>
                    <input class="check-data-config-global"  type="checkbox" name="ADMIN_FOOTER_OFF" {{ bc_config_global('ADMIN_FOOTER_OFF')?"checked":"" }}>
                  </td>
                </tr>
               </tbody>
             </table>
