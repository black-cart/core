...
if (!function_exists('bc_currency_render')) {
    /**
     ...
     */
    function bc_currency_render(float $money, $currency = null, $rate = null, $space_between_symbol = false, $useSymbol = true)
    {
        return ShopCurrency::render($money, $currency, $rate, $space_between_symbol, $useSymbol);
    }
}

if (!function_exists('bc_currency_render_symbol')) {
    /**
     ...
     * @return  [type]                        [return description]
     */
    function bc_currency_render_symbol(float $money, $currency = null, $space_between_symbol = false, $include_symbol = true)
    {
        $currency = $currency ? $currency : bc_currency_code();
        return ShopCurrency::onlyRender($money, $currency, $space_between_symbol, $include_symbol);
    }
}


if (!function_exists('bc_currency_value')) {
/**
 ...
 * @return  [type]         [return description]
 */
    function bc_currency_value(float $money, float $rate = null)
    {
...
//Get code currency
if (!function_exists('bc_currency_code')) {
    function bc_currency_code()
    {
...
//Get symbol currency
if (!function_exists('bc_currency_symbol')) {
    function bc_currency_symbol()
    {
...
//Get rate currency
if (!function_exists('bc_currency_rate')) {
    function bc_currency_rate()
    {
...
if (!function_exists('bc_currency_format')) {
    function bc_currency_format(float $money)
    {
...
//Get currency info
if (!function_exists('bc_currency_info')) {
    function bc_currency_info()
    {
...
//Get all currencies
if (!function_exists('bc_currency_all')) {
    function bc_currency_all()
    {
...
if (!function_exists('bc_currency_all_active')) {
    function bc_currency_all_active()
    {
...
if (!function_exists('bc_convert_price_to_origin')) {
    function bc_convert_price_to_origin(float $money)
    {
