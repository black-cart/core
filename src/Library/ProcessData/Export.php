 ...
 */
namespace BlackCart\Core\Library\ProcessData;
...
class Export
{
    ...
    public static function exportInvoice($dataExport = [], $options = [])
    {
        ...
        $spreadsheet = $reader->load(public_path('admin/black/export/invoice.xlsx'));
        $worksheet = $spreadsheet->getActiveSheet();
...
//logo
        ...
        $drawing->setPath(public_path(bc_store('logo')));
